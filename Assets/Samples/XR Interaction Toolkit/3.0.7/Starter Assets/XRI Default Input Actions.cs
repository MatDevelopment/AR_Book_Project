...
public partial class @XRIDefaultInputActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""Touch"",
            ""id"": ""9ef81db7-edb4-4e89-bb3e-74228a3bbdf9"",
            ""actions"": [
                {
                    ""name"": ""PrimaryContact"",
                    ""type"": ""PassThrough"",
                    ""id"": ""5212b4c4-fda3-4027-8d43-db50d60e107c"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": ""Press"",
                ...
                },
                {
                    ...
                    ""type"": ""PassThrough"",
                    ""id"": ""cab025d6-43a1-4289-89dd-880baa0613ea"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""1668e778-b024-4212-b3f8-d8c8b2a9251a"",
                ...
                {
                    ""name"": """",
                    ""id"": ""9b76c232-9077-4c61-bb9c-f2cf453429fa"",
        ...
        },
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""e0e4700a-f725-4485-abee-3fcd14b560de"",
                ...
                {
                    ""name"": """",
                    ""id"": ""ec068a05-60d4-4369-b148-41e2151afb62"",
    ...
    ~@XRIDefaultInputActions()
    {
        ...
        UnityEngine.Debug.Assert(!m_Touch.enabled, "This will cause a leak and performance issues, XRIDefaultInputActions.Touch.Disable() has not been called.");
    ...
    {
        private @XRIDefaultInputActions m_Wrapper;
        public TouchActions(@XRIDefaultInputActions wrapper) { m_Wrapper = wrapper; }
